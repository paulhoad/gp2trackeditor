...
public:
	...
	CTrackTree *getMainTree()
	{
	  return theMainTree;
	}

	BOOL CheckCurrentEditorVersion();

	void OnTrackView(CDocument *pDoc);
	void OnTrackScrollView(CDocument *pDoc);
	void OnPitView(CDocument *pDoc);
	void OnCCView(CDocument *pDoc);
	void OnObjectView(CDocument *pDoc);
	void OnWorldView(CDocument *pDoc);
	void OnCameraView(CDocument *pDoc);
	void OnJamView(CDocument *pDoc);
	void OnInternalView(CDocument *pDoc);
	void OnTrackglView(CDocument *pDoc);


	CObjectView *OnInternalObjectView(CDocument *pDoc);
	void OnCommandStatsView(CDocument *pDoc);
	...
	void OnStartHelp(BOOL reposition=FALSE);
...
// Implementation
	...
	afx_msg void OnInstallTracks();
	afx_msg void OnTableproperties();
	afx_msg void OnUpdateTableproperties(CCmdUI* pCmdUI);
	afx_msg void OnAppExit();
	afx_msg void OnFileNew();
	afx_msg void OnRegister();
	afx_msg void OnCommandIndex();
	...
	afx_msg void OnTableImages();
	afx_msg void OnUpdateTableImages(CCmdUI* pCmdUI);
	...
	afx_msg void OnViewReadobjnames();
	afx_msg void OnUpdateViewReadobjnames(CCmdUI* pCmdUI);
	afx_msg void OnEditAutobackup();
	afx_msg void OnUpdateEditAutobackup(CCmdUI* pCmdUI);
	afx_msg void OnFileOpenF1gp();
	afx_msg void OnHelpQuickkeyreminder();
