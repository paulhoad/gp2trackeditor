...
public:
  ...
  Observer(Observer *ob) : treeNode(NULL), track(ob->track), obtype(ob->obtype)
  {
    parent = ob->parent;
  }
  ...
  BOOL
    isUnknown()
  {
    return ((obtype == t_Unkown) ? TRUE : FALSE);
  }
  BOOL
    isCamera()
  {
    return ((obtype == t_Camera) ? TRUE : FALSE);
  }
  BOOL
    isCommand()
  {
    return ((obtype == t_Command) ? TRUE : FALSE);
  }
  BOOL
    isObject()
  {
    return ((obtype == t_Object) ? TRUE : FALSE);
  }
  BOOL
    isTrackSection()
  {
    return ((obtype == t_TrackSection) ? TRUE : FALSE);
  }
  BOOL
    isPitSection()
  {
    return ((obtype == t_PitSection) ? TRUE : FALSE);
  }
  BOOL
    isJamFile()
  {
    return ((obtype == t_JamFile) ? TRUE : FALSE);
  }
  BOOL
    isInternalObject()
  {
    return ((obtype == t_InternalObject) ? TRUE : FALSE);
  }
  ...
  virtual BOOL
    ChangeDataValue(LPCSTR dataValue)
  {
