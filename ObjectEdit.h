...
// Dialog Data
	...
	void setSection(TrackObjectDefinition *t)
	{		
		m_Id1 = t->getId1();
	...
	void getSection(TrackObjectDefinition *t)
	{
		t->id = m_Id1;
...
protected:
	...
	virtual void OnOK();
	afx_msg void OnSelchangeDetailcombo();
	afx_msg void OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpDrawItemStruct);
	afx_msg void OnClickId2Spin(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnChangeId2();
	afx_msg void OnSelchangeId1();
