...
public:
	...
	void setSection(TrackSection *t);

	void ValToKerbs(int val);
	void ValToSign(int val);
	void ValToCombo(int val);

	void getSection(TrackSection *t);
	

	BOOL EditTrackSections(TrackSection *t);
...
protected:
	...
	afx_msg void OnKerb();
	afx_msg void OnSign();
	afx_msg void OnChangeFeature1();
	afx_msg void OnChangeFeature2();
	afx_msg void OnFound();
	afx_msg void OnSigncodes();
	afx_msg void OnNext();
	afx_msg void OnPrev();
	virtual BOOL OnInitDialog();
	afx_msg void OnSelchangeSignCombo();
	afx_msg void OnHelp();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
