...
BEGIN_MESSAGE_MAP(CTrackEditorDoc, CDocument)
	...
	ON_COMMAND(ID_FILE_IMPORT_IMPORTTRACKSEGMENTDATA, OnFileImportImporttracksegmentdata)
	ON_COMMAND(ID_EXPORT_TRACK_XY, OnExportTrackXy)
	ON_COMMAND(ID_CREATE_CCLINE_PONK, OnCreateCclinePonk)
	ON_COMMAND(ID_REMOVE_REMOVEALLWALLHEIGHTCHANGES, OnRemoveRemoveallwallheightchanges)
	ON_COMMAND(ID_REMOVE_REMOVEALLTRACKWIDTHCHANGES, OnRemoveRemovealltrackwidthchanges)
	ON_COMMAND(ID_REMOVE_REMOVEEVERYSCENERYCOMMAND, OnRemoveRemoveeveryscenerycommand)
	...
	ON_COMMAND(ID_REMOVE_REMOVEMARTJINSSUGGESTEDSCENERY, OnRemoveRemovemartjinssuggestedscenery)
	...
	ON_COMMAND(ID_REMOVE_REMOVEINTERNALOBJECTNAMES, OnRemoveRemoveinternalobjectnames)
	...
	ON_COMMAND(ID_FILE_EXPORT_EXPORTTOTXFTRACKEXCHANGEFORMAT, OnFileExportExporttotxftrackexchangeformat)
...
ccTable(NULL),pitTable(NULL),trackTable(NULL),objectTable(NULL),F1GP(false)
{
	maintrack   = NULL;
	overlay     = NULL;
	currentJam  = NULL;
...
void CTrackEditorDoc::DeleteContents()
{
	...
	if (mytrack!=NULL) 
	{
		...
		{
			char buff[256];
			wsprintf(buff,"The track %s has been modified since it was last would you like to save this file?",mytrack->getCircuitName());
		...
		if (mytrack->TrackRootNode) theApp.getMainTree()->deleteNode(mytrack->TrackRootNode);
...
BOOL CTrackEditorDoc::OnNewDocument()
{
	AfxMessageBox("This is an experimental option to create new track from scratch, track may not work!");
...
void CTrackEditorDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
#ifdef _DEBUG
void CTrackEditorDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CTrackEditorDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
BOOL CTrackEditorDoc::OnOpenDocument(LPCTSTR lpszPathName) 
{
...
void CTrackEditorDoc::MakeVisible(HTREEITEM Node)
{
	if (Node!=NULL)
	{
...
CSize CTrackEditorDoc::GetSize(double scale)
{
...
CSize CTrackEditorDoc::FindTopLeft()
{
	GPTrack *track = getTrack();
	CSize totalSize;
...
void CTrackEditorDoc::OnFileSaveAs() 
{
	GPTrack * mytrack = getTrack();
	...
	CString dirName = pApp->GetProfileString(strSection, strStringItem,"c:\\gp2\\Circuits");

	//SetCurrentDirectory(dirName);
	
	if (mytrack->isCountryDefined())
	{
	 wsprintf(fileName,"%s_%s_%s.dat",mytrack->circuitName,mytrack->countryName,mytrack->circuitYear);
	}
	else
	{
	...
	fdlg = new CFileDialog(FALSE,"dat",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszFileFilter);
...
void CTrackEditorDoc::OnPitlane() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnObjects() 
{
	// TODO: Add your command handler code here
    GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnChecksum() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditRemoveallbanks() 
{
	// TODO: Add your command handler code here
    GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditRemoveallheight() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	mytrack->regenerate=TRUE;
...
void CTrackEditorDoc::OnViewTrackstatistics() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditRemoveallangles() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	mytrack->regenerate=TRUE;
...
void CTrackEditorDoc::OnEditRemoveallccangles() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditRemoveallccargs() 
{
	// TODO: Add your command handler code here
	
}

void CTrackEditorDoc::OnEditRemoveallccradius() 
{
	// TODO: Add your command handler code here
	
}

void CTrackEditorDoc::OnEditSettracklengths20() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditRemoveallarg2() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditRemoveallccarg1() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditTrackname() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnFileSave() 
{
	// TODO: Add your command handler code here
	//OnFileSaveAs();
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnFileClose() 
{
	CDocument::OnFileClose();
}


void CTrackEditorDoc::OnRegenerateTrack() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();

	int res = AfxMessageBox("This option is a current in development, it may trash your track completely",MB_YESNO);
...
void CTrackEditorDoc::OnTablesCclinedata() 
{
	// TODO: Add your command handler code here
	theApp.OnCCView(this);
}

void CTrackEditorDoc::OnTablesPitlanedata() 
{
	// TODO: Add your command handler code here
	theApp.OnPitView(this);
}

void CTrackEditorDoc::OnTablesTrackdata() 
{
	// TODO: Add your command handler code here
	theApp.OnTrackView(this);
}

void CTrackEditorDoc::OnEditRemoveallfeature1() 
{
	// TODO: Add your command handler code here
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditRemoveallfeature2() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	mytrack->regenerate=TRUE;
...
void CTrackEditorDoc::OnEditCccarsetup() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnObjectdata() 
{
	// TODO: Add your command handler code here
...
static char lpszCamFilter[] = "F1GP2 Camera Files (*.cam)|*.cam|All Files (*.*)|*.*|";
...
void GetInfo(GPTrack * mytrack,FILE *fp)
{
	...
	while(!feof(fp))
    {
	  ...
	  sscanf(CamStr,"%d%n",&number,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&X,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&Y,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&Z1,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&Z2,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&SM,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&ZF1,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&ZF2,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&VR1,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&VR2,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&UNK1,&pos);CamStr+=pos;
	  sscanf(CamStr,"%d%n",&UNK2,&pos);CamStr+=pos;

	  Camera *cam = new Camera(mytrack,number,X,Y,Z1,Z2,SM,ZF1,ZF2,VR1,VR2,UNK1,UNK2);
...
void importCam(GPTrack * mytrack, CString filename)
{
	char *buff;
...
void exportCam(GPTrack * mytrack, CString filename)
{
	...
	fprintf(fp,"[cameras]\n");
	fprintf(fp,"Track Cameras for %s %s\n",mytrack->circuitName,mytrack->countryName);
	fprintf(fp,"v1.3\n");
	fprintf(fp,"#    X      Y      Z1     Z2    SM     ZF1    ZF2    VR1    VR2    UK1    UK2\n");
	fprintf(fp,"=======================================================================================\n");
...
void CTrackEditorDoc::OnImport() 
{
	...
	CFileDialog *fdlg = new CFileDialog(TRUE,"cam",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszCamFilter);
	...
	if (result != IDCANCEL)
	{
	   char message[256];
	   CString filename = fdlg->GetFileName();
	   wsprintf(message,"Importing Camera Settings from file %s (Currently not supported)",filename);
...
void CTrackEditorDoc::OnExport() 
{
	...
	strcpy(fileName,"unnamed.cam");
	CFileDialog *fdlg = new CFileDialog(FALSE,"cam",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszCamFilter);
...
void CTrackEditorDoc::OnFileDebugoutput() 
{
	// TODO: Add your command handler code here
...
void CTrackEditorDoc::OnUpdateExport(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	//pCmdUI->SetEnabled(FALSE);
}

void CTrackEditorDoc::OnUpdateImport(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
...
void CTrackEditorDoc::OnCreateCcline() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	...
	for(int i=0;i<mytrack->TrackSections->size();i++)
	{
	  ...
	  {
	   CCLineSection *nCCsec = new CCLineSection(mytrack,len,sectorRadius,0,sign,0,0,0x50,0);
...
void CTrackEditorDoc::OnRandomObject() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	...
	for(int i=0;i<mytrack->TrackSections->size();i++)
	{
		...
		for(int j=0;j<num;j++)
		{
		 ...
		 TRACE("pos=%d xpos=%d\n",pos,xpos);
		 TrackObjectDefinition *obj = (TrackObjectDefinition*)mytrack->TrackObjectDefintions->elementAt(pos);
		 	    
	     TrackObject *trackcmd = new TrackObject(mytrack,t,xpos,obj->getLocator(),0);
...
void CTrackEditorDoc::OnRemoveTrackcmds() 
{
...
void CTrackEditorDoc::OnRemovePitobjs() 
{
	if (!CheckDoYouWantTo()) return;
    GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnRemovePitcmds() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnRemoveTrackobjs() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnWorldview() 
{
	// TODO: Add your command handler code here
	theApp.OnWorldView(this);
}

void CTrackEditorDoc::OnWalls() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
#define UPDATE_TRACK(x)  GPTrack * mytrack = getTrack();pCmdUI->SetCheck(mytrack->x);


void CTrackEditorDoc::OnUpdateWalls(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	UPDATE_TRACK(showWalls);
}

void CTrackEditorDoc::OnUpdateTrack(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
    UPDATE_TRACK(showTrack);	
}

void CTrackEditorDoc::OnUpdatePitlane(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	UPDATE_TRACK(showPitLane);
}

void CTrackEditorDoc::OnUpdateObjects(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
...
void CTrackEditorDoc::OnFillpolygon() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnUpdateFillpolygon(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	UPDATE_TRACK(showFilledObjects);
}

void CTrackEditorDoc::OnShowTracksides() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnUpdateShowTracksides(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
...
void CTrackEditorDoc::OnTablesTrackview() 
{
	// TODO: Add your command handler code here
	theApp.OnTrackScrollView(this);
}

void CTrackEditorDoc::OnCloseDocument() 
{
	CDocument::OnCloseDocument();
}

void CTrackEditorDoc::OnViewCommands() 
{
	// TODO: Add your command handler code here
	theApp.OnCommandStatsView(this);
}

void CTrackEditorDoc::OnRemoveXxTrackcmds() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
    ...
    if (result == IDOK)
	{
	  ...
	  msg.Format("About to Remove all commands %d 0x%x\nDo you want me to continue",cmdval,cmdval);
...
CTreeCtrl *CTrackEditorDoc::getTree()
{
...
void CTrackEditorDoc::OnRemoveScenery() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnZeroScenery() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnRemoveSand() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnMovePitentrance() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	...
	if (result == IDOK)
	{
		if (dlg->m_Entrance < 0 || dlg->m_Entrance > (mytrack->TrackSections->size()-1))
		{
	    ...
	    TrackSection *Start    = (TrackSection*)mytrack->TrackSections->elementAt(lastEntrance);
	    TrackSection *newStart = (TrackSection*)mytrack->TrackSections->elementAt(mytrack->PitLaneEntryIndex);
		...
		{
	    TrackSection *Start    = (TrackSection*)mytrack->TrackSections->elementAt(lastExit);
	    TrackSection *newStart = (TrackSection*)mytrack->TrackSections->elementAt(mytrack->PitLaneExitIndex);
...
void CTrackEditorDoc::OnMovePitexit() 
{
	// TODO: Add your command handler code here
	
}

void CTrackEditorDoc::OnViewPitlaneInfo() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnFindCommand() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnFindAgain() 
{
   GPTrack * mytrack = getTrack();
   TrackSection *t = mytrack->FindTrackCommand(lastCommand,lastSearch);
...
void CTrackEditorDoc::OnUpdateFindAgain(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(lastCommand!=-1);
}

void CTrackEditorDoc::OnRefreshTree() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();	
	mytrack->createTrack(this);
...
void CTrackEditorDoc::OnCameraView() 
{
	// TODO: Add your command handler code here
...
void CTrackEditorDoc::OnAddRoadsigns() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnRemovePitlaneHeight() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
	mytrack->regenerate=TRUE;
...
void CTrackEditorDoc::OnShowJam() 
{
	// TODO: Add your command handler code here
...
void CTrackEditorDoc::OnEditDrivingLine() 
{
	// TODO: Add your command handler code here
...
void CTrackEditorDoc::OnExportTrackCmds() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	...
	CFileDialog *fdlg = new CFileDialog(FALSE,"txt",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,NULL);
...
static char lpszObjFilter[] = "F1GP2 Object Files (*.gpo)|*.gpo|All Files (*.*)|*.*|";

void CTrackEditorDoc::OnInsertInternalObject() 
{
	GPTrack * mytrack = getTrack();
	// TODO: Add your command handler code here
	char fileName[256];
	...
	CFileDialog *fdlg = new CFileDialog(TRUE,"gpo",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszObjFilter);
...
void CTrackEditorDoc::OnExportObjectInfo() 
{
	// TODO: Add your command handler code here
	HTREEITEM selected = getTree()->GetSelectedItem();
...
void CTrackEditorDoc::OnView3dobject() 
{
...
void CTrackEditorDoc::OnEditScaletrack() 
{
	// TODO: Add your command handler code here
...
void CTrackEditorDoc::OnCcScalar() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnExportNamelist() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnCreateCcLinetwo() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
	...
	for(int i=0;i<mytrack->TrackSections->size();i++)
	{
	  ...
	  if (currentLength >= mytrack->CCLineStartX.GetValue())
	  {
	   if (rad!=0 && len > 10)
	   {
		  ...
		  for(int i=0;i<num;i++)
		  {
	       CCLineSection *nCCsec = new CCLineSection(mytrack,10,sectorRadius,0,sign,0,0,0x50,0);
		   mytrack->CCLineSections->addElement(nCCsec);
		  }
		  if (rem!=0)
		  {
		  CCLineSection *nCCsec = new CCLineSection(mytrack,rem,sectorRadius,0,sign,0,0,0x50,0);
		  mytrack->CCLineSections->addElement(nCCsec);
		  }
	   }
	   else
...
void CTrackEditorDoc::OnEditCopy() 
{
	if (theApp.getMainTree())
	   theApp.getMainTree()->OnCopy();
}

void CTrackEditorDoc::OnEditCut() 
{
	if (theApp.getMainTree())
	   theApp.getMainTree()->OnCut();
}

void CTrackEditorDoc::OnEditPaste() 
{
	if (theApp.getMainTree())
	   theApp.getMainTree()->OnPaste();
}

void CTrackEditorDoc::OnTableScenery() 
{
...
void CTrackEditorDoc::OnStandardscenery() 
{
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnNewObjectDefinition() 
{
	GPTrack * track = getTrack();
...
void CTrackEditorDoc::SetTitle(LPCTSTR lpszTitle) 
{
     CDocument::SetTitle(lpszTitle);
}

char lpszTrifFilter[] = "Track Interchange File Format (*.trif)|*.trif|All Files (*.*)|*.*|";

void ParseTrifFile(FILE *fp,GPTrack *track);
void  ImportTrifFile(GPTrack *track,CString filename);


void CTrackEditorDoc::OnImportTrif() 
{
	GPTrack * mytrack = getTrack();
	...
	CFileDialog * fdlg = new CFileDialog(TRUE,"trif",(LPCSTR)&fileName,OFN_HIDEREADONLY,lpszTrifFilter);
...
void ParseTrifFile(FILE *fp,GPTrack *track)
{
	...
	while(!feof(fp))
	{
		...
		if (line[0] == 't')
		{
			...
			{
			 TrackSection * t = (TrackSection*)track->TrackSections->elementAt(index);
			 if (cmd == 0)
			 {
			  int length,ang,climb,rs,cb,wr,wl;
			  sscanf(line,"t%*d %*x %d %d %d %d %d %d %d",&length,&ang,&climb,&rs,&cb,&wr,&wl);			 			  
			  if (t)
			  {
			  t->setLength(length);
			 ...
			 else if (cmd >= 0x80)
			 {
			   ...
			   nargs+=1;
			   TrackCmd *trackcmd = new TrackCmd(track,t,cmd,0,"Unknown Command");			   
	           Vector *SectionCmds = t->getCommands();
			   line+=npos;
		...
		if (line[0] == 'p')
		{
			...
			{
			   TrackSection * t = (TrackSection*)track->PitlaneSections->elementAt(index);			  
			   if (cmd == 0)
			   {
			   int length,ang,climb,rs,cb,wr,wl;
			   sscanf(line,"p%*d %*x %d %d %d %d %d %d %d",&length,&ang,&climb,&rs,&cb,&wr,&wl);			 
			   if (t)
			   {
			   t->setLength(length);
			   t->setAngle(AngleToDeg(ang));
...
void CTrackEditorDoc::OnRemoveTrackcmdsNonzero() 
{
	GPTrack * mytrack = getTrack();
	int result = AfxMessageBox("Are you sure you want to remove all Track Commands",MB_YESNO);
...
void CTrackEditorDoc::OnTrackRemoveAll() 
{
	GPTrack * mytrack = getTrack();

	int result = AfxMessageBox("Are you sure you want to remove all TrackSections",MB_YESNO);
...
void CTrackEditorDoc::OnJamIndex() 
{
...
void CTrackEditorDoc::OnRemoveTrackAnnotations() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack *track = getTrack();
	...
	for(i=0;i<track->PitlaneSections->size();i++)
	{
...
void CTrackEditorDoc::OnDefaultTyreWallTexture() 
{
	GPTrack *track = getTrack();
...
void CTrackEditorDoc::OnDefaultGravelTexture() 
{
	GPTrack *track = getTrack();
	CTextureChooser *tc = new CTextureChooser(track);
...
void CTrackEditorDoc::OnDefaultTarmacTexture() 
{
	GPTrack *track = getTrack();
	CTextureChooser *tc = new CTextureChooser(track);
...
void CTrackEditorDoc::OnTrackglview() 
{
	// TODO: Add your command handler code here
	if (!CheckRegistrationName())
	{
	   AfxMessageBox("Cannot View TrackSection View in Unregistered version");
	   theApp.OnAppAbout();
	   return;
	}
...
static char lpszCCLogFilter[] = "CC Data Log Files (*.coo)|*.coo|All Files (*.*)|*.*|";

void CTrackEditorDoc::OnFileImportccrecord() 
{
	char fileName[256];
	GPTrack *track = getTrack();

	strcpy(fileName,"unnamed.txt");
	CFileDialog *fdlg = new CFileDialog(TRUE,"coo",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszCCLogFilter);
...
static char lpszTrackSegmentLogFilter[] = "Track Segment Files (*.seg)|*.seg|All Files (*.*)|*.*|";

void CTrackEditorDoc::OnFileImportImporttracksegmentdata() 
{
	char fileName[256];
	GPTrack *track = getTrack();

	strcpy(fileName,"unnamed.seg");
	CFileDialog *fdlg = new CFileDialog(TRUE,"seg",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszTrackSegmentLogFilter);
...
static char lpszXYLogFilter[] = "XY Data Log Files (*.csv)|*.csv|All Files (*.*)|*.*|";


void CTrackEditorDoc::OnExportTrackXy() 
{
	char fileName[256];
	GPTrack *track = getTrack();

	strcpy(fileName,"unnamed.csv");
	CFileDialog *fdlg = new CFileDialog(FALSE,"csv",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszXYLogFilter);
...
void CTrackEditorDoc::OnCreateCclinePonk() 
{
	GPTrack * mytrack = getTrack();
	...
	for(int i=0;i<mytrack->TrackSections->size();i++)
	{
	  ...
	  if (currentLength >= mytrack->CCLineStartX.GetValue())
	  {
		 ...
		 if (rad != 0)
		 {
		  cclen    = (((aa*TrackAngle)+ab)*(TrackLength))+((ac*TrackAngle)+ad);
		  ccradius = (int)(((ba*TrackAngle)+bb)*log(TrackLength))+((bc*TrackAngle))+bd;

		  if (rad < 0) ccradius = -ccradius;

		  RadiusFrom(ccradius,sign);
		 }
		 CCLineSection *nCCsec = new CCLineSection(mytrack,(int)cclen,ccradius,0,sign,0,0,0x50,0);
		 mytrack->CCLineSections->addElement(nCCsec);   
	  }
	  else
	  {
...
void CTrackEditorDoc::OnRemoveRemoveallwallheightchanges() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnRemoveRemovealltrackwidthchanges() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnRemoveRemoveeveryscenerycommand() 
{	
	if (!CheckDoYouWantTo()) return;
...
void CTrackEditorDoc::OnRemoveRemoveall() 
{
	if (!CheckDoYouWantTo()) return;
...
BOOL CTrackEditorDoc::CheckTrackObjectOverlap(CDialog *idlg)
{
	BOOL overlap=FALSE;
	...
	for(i=0;i<mytrack->TrackSections->size();i++)
	{
		TrackSection *t = (TrackSection*)mytrack->TrackSections->elementAt(i);
		...
		if (t->containsCommand(0x80))
		{
			...
			for(int j=0;j<objs->size();j++)
			{
				...
				if (index < len)
				{
				 ...
				 {								 
					int idx = mytrack->TrackSections->findElementIndex((positions[index]->owner));
					CString msg;
					msg.Format("An object in t%d [%s] overlays object in t%d [%s]",idx,positions[index]->getObjectName(),i,obj->getObjectName());
					dlg->Output(msg);
					overlap = TRUE;
				 }
				 else
	...
	for(i=0;i<mytrack->PitlaneSections->size();i++)
	{
		TrackSection *t = (TrackSection*)mytrack->PitlaneSections->elementAt(i);
		...
		if (t->containsCommand(0x80))
		{
			...
			for(int j=0;j<objs->size();j++)
			{
				...
				if (index < len)
				{
				 if (positions[index]!=NULL)
				 {								 
					int idx = mytrack->PitlaneSections->findElementIndex((positions[index]->owner));
					CString msg;
					msg.Format("An object in p%d [%s] overlays object in p%d [%s]",idx,positions[index]->getObjectName(),i,obj->getObjectName());
					dlg->Output(msg);
					overlap = TRUE;
				 }
				 else
...
void CTrackEditorDoc::OnEditPerformsanitycheck() 
{
	int failureCount=0;
	...
	if (distancetoA1!=-1 && distancetoA2!=-1 && distancetoA3 != -1 && distancetoA4!=-1){
	...
	for(i=0;i<mytrack->CCLineSections->size();i++)
	{
	   CCLineSection *t = (CCLineSection*)mytrack->CCLineSections->elementAt(i);
	...
	// was 1500
	TEST_IT("Track+Pit Too Long",((mytrack->totalLength()+mytrack->totalPitLength()) < (1000.0*(7.789/LENGTH_TO_KM))));	
	max_length.Format("Max Length (Track + Pit) is currently %d Units",(int)(1000.0*(7.789/LENGTH_TO_KM)));
	dlg->Output(max_length);
	TEST_IT("Track Too Short ",(mytrack->totalLength() > 500));
	dlg->Output("");
	TEST_IT("Too Many Jam Files ( < 27)",(mytrack->JamFiles->size() <= 27+NON_JAMS));
	...
	TEST_IT("Checking for Overlapping Objects (2 or more objects at the same distance from s/f)",!overlap);
	dlg->Output("");
	...
	for(i=0;i<mytrack->TrackSections->size();i++)
	{
		...
		if(height!=0) { 
			...
			double den = m/sin(Deg2Rad(m/2.0))/sin(Deg2Rad(m/2.0+GradientAtBeginning)); 
	...
	{
		CString msg;
		msg.Format("You track failed %d tests and may need some work before working",failureCount);
		dlg->Output(msg);
		dlg->Output("");
	}
	else {
...
void CTrackEditorDoc::OnRemoveRemovemartjinssuggestedscenery() 
{
	int result = AfxMessageBox("This command removes all scenery commands, (0xB0,0xB9,0xBA,0xC0,0xC1,0xD9) ok!",MB_YESNO);
...
void CTrackEditorDoc::OnHelpScenerylocationtypeb() 
{
	AfxMessageBox("Ribbon 1 = 1\nRibbon 2 = 2\nRibbon 3=4\nRibbon 4=8\nBank Left  = 16\nBank Right = 32",MB_ICONINFORMATION);
}

void CTrackEditorDoc::OnPitlanePitstopstratergy() 
{
...
static char lpszVariousFilter[] = "Various Data Files (*.txt)|*.txt|Comma Separated (*.csv)|*.csv|All Files (*.*)|*.*|";




void CTrackEditorDoc::OnFileExportExportvariousblocks() 
{
	char fileName[256];

	strcpy(fileName,"various.csv");
	CFileDialog *fdlg = new CFileDialog(FALSE,"csv",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszVariousFilter);
...
static char lpszCCSetupFilter[] = "CCSetup Data Files (*.txt)|*.txt|Comma Separated (*.csv)|*.csv|All Files (*.*)|*.*|";

void CTrackEditorDoc::OnFileExportExportccsetup() 
{
	char fileName[256];

	strcpy(fileName,"ccsetup.csv");
	CFileDialog *fdlg = new CFileDialog(FALSE,"csv",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszCCSetupFilter);
...
void CTrackEditorDoc::OnHelpScenerylocationtypebc() 
{
	AfxMessageBox("Road = 10\nPit Road = 20\nLeft Verge = 9\nRight Verge = 8\nLeft Fence = 5\nRight Fence = 4\nLeft Bank = 18\nRight Bank=19\nRibbon 1 = 11\nRibbon 2 = 12\nRibbon 3=13\nRibbon 4=14\n",MB_ICONINFORMATION);
}

void CTrackEditorDoc::OnHelpScenerylocationtypea() 
{
	AfxMessageBox("Left Fence = 1\nRight Fence = 2\nLeft Verge = 16\nRight Verge = 32\nLeft Bank = 64\nRight Bank=128\nRibbon 1 = 256\nRibbon 2 = 512\nRibbon 3=1024\nRibbon 4=2048\n",MB_ICONINFORMATION);// TODO: Add your command handler code here
	
}

void CTrackEditorDoc::OnHelpJamidsunusable() 
{
	AfxMessageBox(
"fuel.jam 18-21 \n"\
"cshad1.jam 225 \n"\
...
void CTrackEditorDoc::OnTablePitScenery() 
{
...
void CTrackEditorDoc::OnCclineStraightenccline() 
{
	if (!CheckDoYouWantTo()) return;
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnEditClearccline() 
{
	if (!CheckDoYouWantTo()) return;
	// TODO: Add your command handler code here
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnShowTextures() 
{
	GPTrack *track = getTrack();
...
void CTrackEditorDoc::OnUpdateShowTextures(CCmdUI* pCmdUI) 
{
	GPTrack *track = getTrack();
	pCmdUI->SetCheck(track->showTextures);
}

void CTrackEditorDoc::OnTexturemapobjects() 
{
	GPTrack *track = getTrack();
	track->showTextures = !track->showTextures;
	UpdateAllViews(NULL);
...
void CTrackEditorDoc::OnUpdateTexturemapobjects(CCmdUI* pCmdUI) 
{
	GPTrack *track = getTrack();
	pCmdUI->SetCheck(track->showTextures);
...
void CTrackEditorDoc::OnRightpopRenameobject() 
{
	CTreeCtrl *tree = getTree();
	...
	if (tree!=NULL)
	{
	 ...
	 if (selected != NULL)
	 {
		...
		{ 
		 ...
		 if (dlg->DoModal() == IDOK)
		 {
		 track->InternalObjectNames->addElement(new IO_name(InObj,strdup((LPSTR)(LPCSTR)dlg->m_ObjName)));
		 InObj->setObjectName(strdup((LPSTR)(LPCSTR)dlg->m_ObjName));
		 }
		 delete dlg;
		}
		else
...
void CTrackEditorDoc::OnRightpopProperties() 
{
	CTreeCtrl *tree = getTree();
...
void CTrackEditorDoc::OnHelpGp2palette() 
{
	CPaletteChooser *dlg = new CPaletteChooser();
	dlg->DoModal();
}

void CTrackEditorDoc::OnViewShowcameras() 
{
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnUpdateViewShowcameras(CCmdUI* pCmdUI) 
{
	GPTrack * mytrack = getTrack();
	pCmdUI->SetCheck(mytrack->showCameras);
}

void CTrackEditorDoc::OnRemoveRemoveallillegalcameras() 
{
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnRemoveAutospacecameras() 
{
	GPTrack * mytrack = getTrack();
	...
	for(int i=0;i<mytrack->TrackCameras->size();i++)
	{
		...
		cam->setSwitchMoment((i*interCamDistance+ (interCamDistance/2))+16384);
...
BOOL CTrackEditorDoc::CheckPitlaneBoxes(CSanity *dlg)
{
	GPTrack * mytrack = getTrack();
	...
	for(int i=0;i<mytrack->PitlaneSections->size();i++)
	{
		...
		if (!Before0x9f && Before0xA0)
		{
		   ...
		   {
			   CString msg;
			   msg.Format("Pit Entrance & Exit Boxes Not Checked between 0x9f && 0xA0 commands p[%d]",i);
			   dlg->Output(msg);
			   return FALSE;
		   }
		   if (pitEntrance && pitExit)
		   {
			   ...
			   {
				  CString msg;
				  msg.Format("Both Entrance and Exit  are checked before a period of just entrance being checked p[%d]",i);
				  dlg->Output(msg);
				  return FALSE;
			   }
		   }
		   else if (pitEntrance)
		   {
			   ...
			   {
				  CString msg;
				  msg.Format("Pit Entrance can only be checked after the 0x9f and before both Entrance and Exit are checked p[%d]",i);
				  dlg->Output(msg);
				  return FALSE;
			   }
		   }
		   else if (pitExit)
		   {
			   ...
			   {
				  CString msg;
				  msg.Format("Pit Exit can only be checked before the 0xA0 and after both Entrance and Exit are checked p[%d]",i);
				  dlg->Output(msg);
				  return FALSE;
			   }
		   }		   
...
void CTrackEditorDoc::OnRemoveRemoveinternalobjectnames() 
{
	GPTrack * mytrack = getTrack();
	mytrack->InternalObjectNames->removeAllElements();
}

void CTrackEditorDoc::OnViewJamtotalsize() 
{
	GPTrack * track = getTrack();
	int size = 0;
...
BOOL CTrackEditorDoc::CheckTrackInWorld(CSanity *dlg)
{
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnObjectjamsTotaljamsize() 
{
	GPTrack * track = getTrack();
	int numberOfJamFiles = track->JamFiles->size();
	...
	for(int i=0;i<numberOfJamFiles;i++)
    {
	  ...
	  if (t)
	  {
			 if (!t->isDefault())
			 {
				 ...
				 totalSize += Size;				 
				 CString nmsg;
				 nmsg.Format("%s \t%d\tTotal:=%d\n",t->getFullPathToJamFileName(),Size,totalSize);
				 msg += nmsg;
			 }
	  }
	}
...
void CTrackEditorDoc::OnFileExportExporttrackinfo() 
{
	GPTrack * mytrack = getTrack();
	...
	// track parts
	double leftSideX = xpos+getLeftSideX(sectorStartAngle,WIDTH_TO_TRACKWIDTH(t->getWidthLeft()));
	double leftSideY = ypos+getLeftSideY(sectorStartAngle,WIDTH_TO_TRACKWIDTH(t->getWidthLeft()));

	double rightSideX = xpos+getRightSideX(sectorStartAngle,WIDTH_TO_TRACKWIDTH(t->getWidthRight()));
	double rightSideY = ypos+getRightSideY(sectorStartAngle,WIDTH_TO_TRACKWIDTH(t->getWidthRight()));

           
	// track parts
	double leftSideNX = xpos+nextxpos+getLeftSideX(sectorEndAngle,WIDTH_TO_TRACKWIDTH(t->getWidthLeft()));
	double leftSideNY = ypos+nextypos+getLeftSideY(sectorEndAngle,WIDTH_TO_TRACKWIDTH(t->getWidthLeft()));

           
	double rightSideNX = xpos+nextxpos+getRightSideX(sectorEndAngle,WIDTH_TO_TRACKWIDTH(t->getWidthRight()));
	double rightSideNY = ypos+nextypos+getRightSideY(sectorEndAngle,WIDTH_TO_TRACKWIDTH(t->getWidthRight()));

	fprintf(fp,"%d %f %f %f %f %f %f %f %f\n",i,leftSideX,leftSideY,rightSideX,rightSideY,rightSideNX,rightSideNY,leftSideNX,leftSideNY);
...
void CTrackEditorDoc::OnEditUndo() 
{
	CString msg;
	char buff[1024];
	GPTrack * mytrack = getTrack();
	...
	int result = AfxMessageBox("GP2 TE Can undo to the last major change\nWould you like me to Undo?",MB_YESNO);
...
void CTrackEditorDoc::OnFileExportExporttotxftrackexchangeformat() 
{
	GPTrack * mytrack = getTrack();
	...
	fprintf(fp,"<TRACK>\n");
	//fprintf(fp,"<TRACKINFO> startx=%d starty=%d starta=%d </TRACKINFO>\n",xpos,ypos,currentangle);
	for(int i=0;i<mytrack->TrackSections->size();i++)
	{
	TrackSection *t = (TrackSection*)mytrack->TrackSections->elementAt(i);		
	fprintf(fp,"<TRK> length=%d angle=%2.2f altitude=%d widthleft=%d widthright=%d </TRK>\n",t->getLength(),t->getAngle(),(int)t->getAltitude(),(int)t->getWidthLeft(),(int)t->getWidthRight());		
	}
	fprintf(fp,"</TRACK>\n");
	fclose(fp);
}
...
void CTrackEditorDoc::OnFileExportExporttovrml() 
{
	char fileName[256];
	GPTrack * mytrack = getTrack();

	strcpy(fileName,"unnamed.wrl");
	CFileDialog *fdlg = new CFileDialog(FALSE,"wrl",(LPCSTR)&fileName,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,lpszVRMLFilter);
...
void CTrackEditorDoc::OnHelp0xc5locationtyped() 
{
	// TODO: Add your command handler code here
	/*
...
*/
AfxMessageBox("grey road(no texture)= 1\n? = 2\nfences/walls=4\n?=8\nroad=16\nverges=32\nbanks=64\nall ribbons=128\npitroad=256\npitroad lines=512\nribbon 1=1024\nribbon 2=2048\nribbon 3=4096\nribbon 4=8192\n? = 16384\n",MB_ICONINFORMATION);


}

void CTrackEditorDoc::OnHelp0xa0locationtypee() 
{
	// TODO: Add your command handler code here

	AfxMessageBox("1: right verge \n2: left verge \n4: right fence \n8: left fence \n16: right bank \n32: left bank \n",MB_ICONINFORMATION);

}

void CTrackEditorDoc::OnShowShowsceneryarms() 
{
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnUpdateShowShowsceneryarms(CCmdUI* pCmdUI) 
{
	UPDATE_TRACK(showSceneryArms);
}

void CTrackEditorDoc::OnShowUseswivelangles() 
{
	GPTrack * mytrack = getTrack();
...
void CTrackEditorDoc::OnUpdateShowUseswivelangles(CCmdUI* pCmdUI) 
{
