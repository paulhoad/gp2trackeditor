...
(ypos+nextypos),xpos,ypos,cx,cy,sectorStartAngle,TotalAngle,Radius+WIDTH_TO_TRACKWIDTH(LeftWidth+EleftWall),Radius+WIDTH_TO_TRACKWIDTH(LeftWidth+EleftWall)+1);
    ...
    else
    {
      // walls parts
double OWleftSideX =
xpos+getLeftSideX(sectorStartAngle,WIDTH_TO_TRACKWIDTH(LeftWidth+leftWall)+1);
double OWleftSideY =
ypos+getLeftSideY(sectorStartAngle,WIDTH_TO_TRACKWIDTH(LeftWidth+leftWall)+1);
double OWleftSideNX =
xpos+nextxpos+getLeftSideX(sectorEndAngle,WIDTH_TO_TRACKWIDTH(LeftWidth+EleftWall)+1);
double OWleftSideNY =
ypos+nextypos+getLeftSideY(sectorEndAngle,WIDTH_TO_TRACKWIDTH(LeftWidth+EleftWall)+1);
...
(ypos+nextypos),xpos,ypos,cx,cy,sectorStartAngle,TotalAngle,Radius-WIDTH_TO_TRACKWIDTH(RightWidth+ErightWall)+1,Radius-WIDTH_TO_TRACKWIDTH(RightWidth+ErightWall));
    ...
    {
            double OWrightSideX =
xpos+getRightSideX(sectorStartAngle,WIDTH_TO_TRACKWIDTH(RightWidth+rightWall)+1);
double OWrightSideY =
ypos+getRightSideY(sectorStartAngle,WIDTH_TO_TRACKWIDTH(RightWidth+rightWall)+1);
    double OWrightSideNX =
xpos+nextxpos+getRightSideX(sectorEndAngle,WIDTH_TO_TRACKWIDTH(RightWidth+ErightWall)+1);
double OWrightSideNY =
ypos+nextypos+getRightSideY(sectorEndAngle,WIDTH_TO_TRACKWIDTH(RightWidth+ErightWall)+1);
