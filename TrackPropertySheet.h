...
public:
  ...
  void
    LoadTable(Observer* obj);

  void
    InsertTableString(int row, int index, LPSTR name, LPARAM extraData);
  void
    InsertTableString(int row, int index, CString name, LPARAM extraData);
  void
    EmptyTable();
