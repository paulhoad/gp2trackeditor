...
CMyListCtrl::CMyListCtrl() { currentEdit = FALSE; }
...
CEdit*
  CMyListCtrl::EditSubLabel(int nItem, int nCol)
{
...
void CMyListCtrl::OnEndLabelEdit(NMHDR* pNMHDR, LRESULT* pResult)
{
  ...
  if (plvItem->pszText != NULL) {
    DataChangeObserver* dataObserver =
      (DataChangeObserver*)GetItemData(plvItem->iItem);
