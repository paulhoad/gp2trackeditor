...
class CSceneryEditor : public CDialog
{
  // Construction
public:
  CSceneryEditor(GPTrack* mytrack, BOOL pitlane = FALSE, int StartingPosition = 0, int StartingCmd = 1,
  ...
  void
    DrawScenery(CDC* pDC, RECT& rect);
  void
    DrawProfile(CDC* pDC, RECT& rect);
  void
    DrawRibbonState(CDC* pDC, RECT& rect);
