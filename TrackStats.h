...
public:
	...
	void setTrack(GPTrack * mytrack)
	{
		...
		m_TrackLenKmPits = (double)(LENGTH_TO_KM * mytrack->totalPitLength())/1000.0;
		m_TrackLenKmBoth = m_TrackLenKm+m_TrackLenKmPits;
		m_TrackLenMiles = (double)(LENGTH_TO_KM * mytrack->totalLength())/METERES_IN_MILE;
		...
		TrackSection *t = (TrackSection*)mytrack->TrackSections->elementAt(mytrack->TrackSections->size()-1);
