...
// Construction
public:
	CPitStopStratergy(GPTrack *mytrack,CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CPitStopStratergy)
	enum { IDD = IDD_PITSTOP };
	CButton	m_OkButton;
...
protected:
	...
	afx_msg void OnChangeThreestop();
	afx_msg void OnChangeOnestop();
	afx_msg void OnChangeTwostop();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
