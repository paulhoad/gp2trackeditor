...
{
	// TODO: Add your control notification handler code here
	AfxMessageBox("Have you Found something!, Please mail the Author if you think you may have some information about what codes do",MB_OK);
}
...
void CTrChangeDlg::OnNext() 
{
	if (currentSection!=NULL)
	{
		...
		getSection(currentSection);
		currentSection->track->createTrack(currentSection->track->GetDocument());	  
		TrackSection *newSection = currentSection->track->GetNextSection(currentSection);
...
void CTrChangeDlg::OnPrev() 
{
	...
	if (currentSection!=NULL)
	{
		...
		getSection(currentSection);
		currentSection->track->createTrack(currentSection->track->GetDocument());	  
		TrackSection *newSection = currentSection->track->GetPreviousSection(currentSection);
		setSection(newSection);
		UpdateData(FALSE);
	}
}
...
void CTrChangeDlg::OnSelchangeSignCombo() 
{
	...
	switch(idex)
	{
	   case 0: v8 = FALSE;v40=FALSE;v80=FALSE;break;
	   case 1: v8 = TRUE;v40=FALSE;v80=FALSE;break;
       case 2: v8 = FALSE;v40=TRUE;v80=FALSE;break;
       case 3: v8 = FALSE;v40=FALSE;v80=TRUE;break;
	   case 4: v8 = TRUE;v40=TRUE;v80=FALSE;break;
	   case 5: v8 = FALSE;v40=TRUE;v80=TRUE;break;	   
	}
