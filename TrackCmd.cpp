...
static t_Cmds CommandDesc[] = {
  ...
  { 0x80,
    ...
    "",
    IDB_OBJECT,
    { "Offset Into Sector", "Object Definition Offset" },
    "No Help For This Command" },
  { 0x81,
    "Display Distance In Front",
    1,
    "W",
    "",
    IDB_EYES,
    { "Offset Into Sector", "View Distance; typical values: 80-255" },
    "No Help For This Command" },
  { 0x82,
    "Display Distance Behind",
    1,
    "W",
    "",
    IDB_EYES,
    ...
    "No Help For This Command" },
  { 0x83,
    "Obsolete (probaly old f1gp commands)",
    0,
    "",
    "",
    IDB_UNK,
    { "unk; typical values: 3" },
    "No Help For This Command" },
  { 0x84,
    "Obsolete (probaly old f1gp commands)",
    0,
  ...
  { 0x85,
    ...
    "",
    IDB_TRACK_CHANGE,
    { "Offset Into Sector", "Transition Length; typical values 4 .. 40", "New Width; typical values: 950 .. 1800" },
    "No Help For This Command" },
  { 0x86,
    "Connect PitLane Start",
    0,
    "W",
    "",
    IDB_PIT,
  ...
  { 0x8a,
    "Track Markings Type A",
    5,
    "W",
    "",
    IDB_TRACK_MARKINGS,
    { "Offset Into Sector",
      "Marking Type; typical values: 3 (gives yellow color) 8 (light grey) "
      "8968 14088 49160",
      "Num Dotted Lines; (determins length of marking); typical values: 2 3 4 "
      "5 6 8 13",
      "Horizontal Movement; (inch; range is about +/-1500)",
      "Angle Of Line; typical values: -620 0 620",
      "Marking Type 2; typical values: 257 513 771 1281" },
    "Many thanks to babbel for finding these a more thorough description\n "
    "The Yellow dotted lines before/after pit entry/exit\nColors 3=Yellow\n "
    "1,2 light Gray\n" },
  { 0x8b,
    "Track Markings Type B",
    5,
    "W",
    "",
    IDB_TRACK_MARKINGS,
  ...
  { 0x8e,
    "Left Kerbs Begin/Length",
    2,
    "",
    "",
    IDB_KERB,
    { "Unused", "Offset Into Sector", "Length" },
    "No Help For This Command" },
  { 0x8f,
    "Right Kerbs Begin/Length",
    2,
    "",
    "",
    IDB_KERB,
  ...
  { 0x90,
    "?Possible CC line command? (backward ref)",
    1,
    "",
    "",
    IDB_UNK,
  ...
  { 0x94,
    ...
    "",
    IDB_GRIP,
    { "Possibly ignore", "Grip Value?" },
    "No Help For This Command" },
  { 0x95,
    "Track Grip/Bumps?/Slide Marks?",
    1,
    "W",
    "",
    IDB_GRIP,
  ...
  { 0x97,
    ...
    "No Help For This Command" },
  { 0x98,
    "Left Fence Height Change",
    1,
    "W",
    "",
    IDB_WALLCHANGE,
    { "Unk?", "New Fence Height; typical values: 1 2 3 4" },
    "No Help For This Command" },
  { 0x99,
    "Right Fence Height Change",
    1,
    "W",
    "",
    IDB_WALLCHANGE,
  ...
  { 0x9a,
    ...
    "",
    IDB_WALLCHANGE,
    { "?Offset Info Sector", "New Height; typical values: 3", "Transision Length; typical values: 256 (see t74 in barcelona)" },
    "No Help For This Command" },
  { 0x9b,
    "Pit Lane Begin Offset",
    0,
    "W",
    "",
    IDB_PIT,
    { "value must be <= the length to 0x9f" },
    "No Help For This Command" },
  { 0x9c,
    "Not USED UNDERDEVELOPMENT",
    0,
    "",
    "",
    IDB_UNK,
    { "" },
    "No Help For This Command" },// NEW
  { 0x9d,
    "Not USED UNDERDEVELOPMENT",
    0,
    "",
  ...
  { 0x9e,
    ...
    "",
    IDB_PIT,
    { "value must be <= the remaining length" },
    "No Help For This Command" },
  { 0x9f,
    "Pit Lane Fences Begin",
    0,
    "",
    "",
    IDB_PIT,
  ...
  { 0xA0,
    ...
    "No Help For This Command" },
  { 0xA1,
    "Pit Lane Entry, Join Right Pit Lane Fence",
    0,
    "",
    "",
    IDB_PIT,
    ...
    "No Help For This Command" },
  { 0xA2,
    "Pit Lane Entry, Join Left Pit Lane Fence",
    0,
    "",
    "",
    IDB_PIT,
    ...
    "No Help For This Command" },
  { 0xA3,
    "Pit Lane Exit, Join Right Pit Lane Fence",
    0,
    "",
    "",
    IDB_PIT,
    ...
    "No Help For This Command" },
  { 0xA4,
    "Pit Lane Exit, Join Left Pit Lane Fence",
    0,
    "",
    "",
    IDB_PIT,
    ...
    "No Help For This Command" },
  { 0xA5,
    "Not USED UNDERDEVELOPMENT (seen in f1gp)",
    0,
    "",
    "",
    IDB_UNK,
  ...
  { 0xA8,
    "Trigger Flag Men Waving at race end!",
    0,
    "WWW",
    "",
    IDB_CHECKED_FLAG,
  ...
  { 0xAD,
    ...
    "",
    IDB_BANK_RIGHT,
    { "Unused", "Length", "Height +ve left -ve right" },
    "No Help For This Command" },
  { 0xAF,
    "Pair of Swivel Arms",
    2,
    ...
    "",
    IDB_SCENERY,
    { "Offset into section", "Distance to Left", "Distance to Right" },
    "No Help For This Command" },
  ...
  { 0xB0,
    ...
    "",
    IDB_SCENERY,
    { "Offset Info Sector", "Location CodeType B (for switched ribbon)" },
    "No Help For This Command" },
  { 0xB1, "Unknown", 1, "W", "", IDB_UNK, { "" }, "No Help For This Command" },
  { 0xB2,
    "Switch Track Side Off",
    1,
    "",
    "",
    IDB_UNK,
    { "Offset Info Sector", "(0,1=left,2=right,3=both) " },
    "Bit 1: turns off the left boundary line. Bit 2: turns off the right "
    "boundary line. This means that value 0 has no effect, 1 turns left line "
    "off, 2 turns right line off and 3 turns both lines off. " },
  ...
  { 0xB4,
    ...
    "WWW",
    "",
    IDB_TRACK_CHANGE_LEFT,
    { "Unused", "Length into sector", "new width (avg~=1500)" },
    "No Help For This Command" },
  { 0xB5,
    "Track Width Change Right",
    2,
    "WWW",
    "",
    IDB_TRACK_CHANGE_RIGHT,
    { "Unused", "Length into sector", "new width (avg~=1500)" },
    "No Help For This Command" },
  { 0xB6,
    "Pitlane Start Angle (adjustment)",
    1,
    "",
    "",
    IDB_PIT,
    { "Unused", "Pitlane Angle" },
    "No Help For This Command" },
  { 0xB7,
    "Pitlane Start Height (adjustment)",
    1,
    "",
    "",
    IDB_PIT,
    { "Unused", "Pitlane Height" },
    "No Help For This Command" },
  { 0xB8,
    "Scenery Ribbon Structure",
    13,
    "W",
    "",
    IDB_SCENERY,
    { "unused", "ribbons to the right", "Ribbon 1 x", "Ribbon 1 z", "Ribbon 2 x", "Ribbon 2 z", "Ribbon 3 x", "Ribbon 3 z", "Ribbon 4 x", "Ribbon 4 z", "Ribbon 5 x", "Ribbon 5 z", "Ribbon 6 x", "Ribbon 6 z" },
    "No Help For This Command" },
  { 0xB9,
    "Turn On Ribbons",
    1,
  ...
  { 0xBA,
    ...
    "",
    IDB_SCENERY,
    { "?Offset Info Sector", "Location Code Type B", "?Location Code Type B" },
    "No Help For This Command" },
  { 0xBB,
    "Texture Mapping Light ",
    4,
    "",
    "",
    IDB_OFFSET,
    { "start pos into sector?", "Texture Location?", "length?", "texture?" },
    "No Help For This Command" },
  { 0xBC,
    "Texture Mapping ",
    7,
    ...
    "",
    IDB_SIDE_UNK,
    { "start pos into sector", "Texture Location", "length", "texture", "nbitmaps", "nrows", "y offset", "rotation" },
    "This command is used for markings on road side or armco coverings\n i.e. "
    "adverts,red/white,gravel and grass etc.\nTexture Location:\n4=right "
    "fence\n5=left fence\n8=right road side\n9=left road side" },
  { 0xBD,
    "Light Source (Sun)",
    2,
    ...
    "No Help For This Command" },
  { 0xBE,
    "View-Distance To Banks InFront",
    2,
    "",
    "",
    IDB_EYES,
    { "offset into sector", "location code 32=left 16=right", "new distance" },
    "No Help For This Command" },
  { 0xBF,
    "View-Distance to Banks Behind",
    2,
    "",
    "",
    IDB_EYES,
  ...
  { 0xC0,
    "Single Swivel Arm Left",
    1,
    "",
    "",
    IDB_SCENERY,
    { "distance into sector", "distance to peek" },
    "No Help For This Command" },
  { 0xC1,
    "Single Swivel Arm Right",
    1,
    "",
    "",
    IDB_SCENERY,
  ...
  { 0xC7,
    ...
    "No Help For This Command" },
  { 0xC8,
    "Scenery Texture Definition",
    7,
    "W",
    "",
    IDB_SCENERY,
    { "Unk", "Texture Location", "Length of Repeated Section", "Texture id", "nbitmaps", "nrows", "y offset", "rotation" },
    "No Help For This Command" },
  { 0xC9,
    "Set Colors In GP2-Palette",
    8,
    "W",
    "",
    IDB_SCENERY,
    { "Unused", "Palette Index Begin", "Palette Index End", "Hue Angle Begin", "Hue Angle End", "Saturation Begin", "Saturation End", "Intensity Value Begin", "Intensity Value End" },
    "No Help For This Command" },
  { 0xCA,
    "Type A Kerb Definition ",
    4,
    "WWWWW",
    "",
    IDB_KERB,
    { "Always 0?", "Distance to Height 1", "Distance to Height 2", "Height1", "Height2" },
    "No Help For This Command" },
  { 0xCB,
    "Type B Kerb Definition (click 0x4)",
    4,
    "WWWWW",
    "",
    IDB_KERB,
  ...
  { 0xCC,
    ...
    "No Help For This Command" },
  { 0xCD,
    "Scenery Ribbons Lighten or Darken (Adjust Shadow)",
    3,
    "",
    "",
    IDB_SCENERY,
    { "offset into sector", "location code", "length", "light/darken" },
    "1:wall left\n2:wall right\n16=bank left\n32=bank right\n128=ribbon on "
    "right\n1024=2nd ribbon\n2048=1st ribbon" },
  { 0xCE,
    "Unknown/Monaco Tunnel adjust!",
    1,
    "",
    "",
    IDB_UNK,
    ...
    "No Help For This Command" },
  { 0xCF,
    "Show pit objects through pitwall ",
    1,
    "",
    "",
    IDB_UNK,
    { "offset into sector", "distance effect seen for" },
    "No Help For This Command" },

  { 0xD0,
    "Possible CC line command",
    2,
    "",
    "",
    IDB_CC_LINE,
  ...
  { 0xD2,
    ...
    "",
    IDB_UNK,
    { "Unk?", "Track Grip Level?" },
    "No Help For This Command" },
  { 0xD3,
    "View into Pitlane Entrance",
    1,
    "",
    "",
    IDB_EYES,
  ...
  { 0xD9,
    ...
    "",
    IDB_SCENERY,
    { "Unused", "Ribbon Switch 0=all of -> 15 all on" },
    "No Help For This Command" },
  { 0xDA,
    "Silly Sceney Command",
    1,
    "",
    "",
    IDB_UNK,
    { "Offset Into Sector", "Location Code Type B" },
    "No Help For This Command" },
  { 0xDB,
  ...
  { 0xDE,
    "Black Flag Area Left",
    3,
    "W",
    "",
    IDB_BLACK_FLAG,
    { "Unused", "Begin pos from start", "End Pos from start", "Limited Speed" },
    "No Help For This Command" },
  { 0xDF,
    "Black Flag Area Right",
    3,
    "W",
    "",
    IDB_BLACK_FLAG,
  ...
  //{0xE1,"Kerb Adjust Left (0xCB Kerb) (UNDERDEVELOPMENT DO NOT
  //USE)",1,"","",IDB_KERB,{"Unknown","New Height"},"No Help For This
  //Command"},
};
...
CString
  TrackCmd::getCmdNthArgDescription(int arg)
{
  char buffer[256];
...
#define SET_ARG(x) \
  if (args >= (x)) setNthArg((x), dlg->m_Arg##x);

#define CHECK_ARG(x)                               \
  if (args >= (x)) {                               \
    dlg->m_Arg##x = getNthArg(##x);                \
    dlg->m_Desc##x = getCmdNthArgDescription(##x); \
  }
...
int TrackCmd::OpenSceneryOnOffEditor()
{
  if (owner->isTrackSection()) {
    ...
    CSceneryOnOff *dlg =
      new CSceneryOnOff(getTrack(), getNthArg(1), getNthArg(2));
...
int TrackCmd::OpenSceneryEditor()
{
  if (owner->isTrackSection() || owner->isPitSection()) {
    ...
    CSceneryEditor *dlg =
      new CSceneryEditor(getTrack(), pitLane, index, editing);
