...
{
  // drawSpiral(cx,cy,Deg2Rad(angle1),
  // Deg2Rad(angle1)+Deg2Rad(angle2)/2.0,radius,radius);
...
/*
void Display::drawArcSpecial(double x,double y,double x1,double y1,double
cx,double cy,double angle1,double angle2,double radius)
{
        int sx  = getScreenX(x1);
        int sy  = getScreenY(y1);
        int ex  = getScreenX(x);
...
void Display::setColor(int col)
{
  ...
  case 0:
    ...
    break;
  case 1:
    gr->SelectStockObject(WHITE_PEN);
    break;
  case -2:
    gr->SelectStockObject(BLACK_PEN);
    break;
  ...
  case 2:
    gr->SelectObject(ccpen);
    break;
  case 3:
    gr->SelectObject(roadselpen);
    break;
  case 4:
    gr->SelectObject(ccselpen);
    break;
  case 5:
    gr->SelectObject(redpen);
    break;
  case KERB_LOWER_PEN:
    gr->SelectObject(kerblowerpen);
    break;
  case KERB_PEN:
    gr->SelectObject(kerbpen);
    break;
  case GRASS_BRUSH: {
  ...
  case RED_BRUSH:
    gr->SelectObject(redBrush);
    break;
  case CYAN_BRUSH:
    gr->SelectObject(cyanBrush);
    break;
  case TARMAC_BRUSH: {
